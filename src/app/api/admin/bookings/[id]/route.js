...
export async function PUT(req, context) {
  try {
    ...
    // Fetch user and celebrity for email
    ...
    if (user && celebrity) {
      ...
      await resend.emails.send({
        ...
        subject: isApproved
          ? `🎉 Your booking for ${celebrity.name} has been approved!`
          : `Your booking for ${celebrity.name} was not approved`,
        html: isApproved
          ? `
            <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;background:#000;color:#fff;padding:48px 32px;border-radius:16px;">
              <div style="text-align:center;margin-bottom:32px;">
                <div style="width:72px;height:72px;border-radius:50%;background:#fff;display:flex;align-items:center;justify-content:center;margin:0 auto 20px;">
                  <span style="font-size:32px;">✅</span>
                </div>
                <h1 style="font-size:26px;font-weight:800;color:#fff;margin:0 0 8px;">Booking Approved!</h1>
                <p style="color:rgba(255,255,255,0.5);font-size:14px;margin:0;">Your request has been confirmed</p>
              </div>
              ...
              <div style="background:rgba(255,255,255,0.05);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:24px;margin-bottom:28px;">
                ...
                <p style="font-size:18px;font-weight:700;color:#fff;margin:0 0 20px;">${celebrity.name}</p>

                <p style="font-size:13px;color:rgba(255,255,255,0.4);margin:0 0 4px;text-transform:uppercase;letter-spacing:0.1em;">Event Type</p>
                <p style="font-size:16px;font-weight:600;color:#fff;margin:0 0 20px;">${booking.eventType}</p>
              ...
              <p style="font-size:14px;color:rgba(255,255,255,0.6);line-height:1.7;margin-bottom:28px;">
                Hi ${user.name}, great news! Your booking request for <strong style="color:#fff;">${celebrity.name}</strong> has been approved. 
                Our team will be in touch with further details shortly.
              </p>

              <div style="text-align:center;margin-bottom:32px;">
                <a href="${process.env.NEXTAUTH_URL}/dashboard" style="display:inline-block;background:#fff;color:#000;font-weight:700;font-size:14px;padding:16px 36px;border-radius:999px;text-decoration:none;">
                  View My Bookings
                </a>
              </div>
          ...
          : `
            <div style="font-family:Inter,sans-serif;max-width:600px;margin:0 auto;background:#000;color:#fff;padding:48px 32px;border-radius:16px;">
              <div style="text-align:center;margin-bottom:32px;">
                <div style="width:72px;height:72px;border-radius:50%;background:rgba(255,59,48,0.15);border:1px solid rgba(255,59,48,0.3);display:flex;align-items:center;justify-content:center;margin:0 auto 20px;">
                  <span style="font-size:32px;">❌</span>
                </div>
              ...
              <p style="font-size:14px;color:rgba(255,255,255,0.6);line-height:1.7;margin-bottom:28px;">
                ...
                This may be due to availability or scheduling conflicts. Please feel free to explore other celebrities or try a different date.
              </p>

              <div style="text-align:center;margin-bottom:32px;">
                <a href="${process.env.NEXTAUTH_URL}/celebrities" style="display:inline-block;background:#fff;color:#000;font-weight:700;font-size:14px;padding:16px 36px;border-radius:999px;text-decoration:none;">
