...
export default function AdminDashboard() {
  ...
  const statusColor = (status) => {
    if (status === "APPROVED") return { bg: "rgba(34,197,94,0.1)", color: "#22c55e" };
    if (status === "REJECTED") return { bg: "rgba(255,59,48,0.1)", color: "#ff6b6b" };
    ...
    <div style={{ minHeight: "100vh", background: "#f9f9f9", paddingTop: "68px" }}>
      ...
      <div style={{ background: "#000", paddingTop: "40px", paddingBottom: "40px", paddingLeft: "24px", paddingRight: "24px" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "20px" }}>
          ...
          <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
            ...
            <Link
              href="/admin/bookings"
              style={{ fontSize: "13px", fontWeight: 600, color: "rgba(255,255,255,0.7)", background: "rgba(255,255,255,0.08)", border: "1px solid rgba(255,255,255,0.1)", padding: "12px 24px", borderRadius: "999px", textDecoration: "none" }}
            >
              Manage Bookings
            </Link>
          </div>
      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "16px", marginBottom: "40px" }}>
          {[
            { label: "Total Celebrities", value: stats.totalCelebrities, icon: "🌟", href: "/admin/celebrities" },
            { label: "Total Bookings", value: stats.totalBookings, icon: "📋", href: "/admin/bookings" },
            { label: "Pending Bookings", value: stats.pendingBookings, icon: "⏳", href: "/admin/bookings" },
            { label: "Total Users", value: stats.totalUsers, icon: "👥", href: "#" },
          ].map((stat) => (
            <Link
              key={stat.label}
              href={stat.href}
            ...
            >
              ...
              >
                ...
                <div>
                  <p style={{ fontSize: "28px", fontWeight: 800, color: "#000", lineHeight: 1 }}>
                    {stat.value}
                  </p>
        ...
        <div>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "20px", flexWrap: "wrap", gap: "12px" }}>
            ...
            <Link href="/admin/bookings" style={{ fontSize: "13px", color: "#999", textDecoration: "none" }}>
              View all →
            </Link>
          </div>
          ...
          {recentBookings.length === 0 ? (
            <div style={{ background: "#fff", border: "1px solid #eee", borderRadius: "16px", padding: "48px", textAlign: "center" }}>
              ...
              <p style={{ fontSize: "14px", color: "#999" }}>Bookings will appear here once users start booking celebrities.</p>
            </div>
          ) : (
